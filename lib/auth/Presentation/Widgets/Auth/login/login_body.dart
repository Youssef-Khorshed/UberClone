...
import 'package:flutter_application_2/auth/Presentation/Widgets/Auth/signup/signup.dart';
import 'package:get/get.dart';

import '../../../../../Core/ReuseableComponent/text_form_field_widget.dart';
import '../../home/driverpage.dart';
          ...
          GetBuilder<AuthController>(
            builder: (controller) => ElevatedButton(
              onPressed: () async {
                ...
                if (controller.checkdriver) {
                  preferences.setString('role', 'driver');
                  Get.off(() => DriverPage());
                } else {
                  preferences.setString('role', 'user');
                  Get.off(() => UserPage());
                }
              },
